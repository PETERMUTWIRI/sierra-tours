...
const luxuryPackages = [
  {
    id: 1,
    title: "Royal Mara Experience",
    duration: "5 Days / 4 Nights",
    price: "From $8,500 per person",
    image: "/images/destinations/maasai-mara.jpg",
    description: "The ultimate Mara experience with stays at exclusive luxury camps and private conservancies.",
    highlights: [
  ...
  {
    id: 2,
    title: "Platinum Kenya Safari",
    duration: "7 Days / 6 Nights",
    price: "From $12,000 per person",
    image: "/images/destinations/amboseli-elephants.jpg",
    description: "Journey through Kenya's finest parks in ultimate comfort and style.",
    highlights: [
      "Helicopter transfers",
      "Luxury lodge collection",
  ...
  },
  {
    ...
    description: "The most exclusive safari experience in East Africa. Truly once-in-a-lifetime.",
    highlights: [
      "Private jet between camps",
