...
// Step 2: Extract meta data (note the leading space in patterns)
for (const line of lines) {
  // Price - with leading space
  ...
  // Settings - with leading space (can be very long)
